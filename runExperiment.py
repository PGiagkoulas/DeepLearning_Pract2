...
def run_experiment(repeats=5):
    ...
    for cfg in cfg_list:
        ...
        for r in range(repeats):
            score, aux_score = evaluate_cnnlstm_multi_model(trainX, trainy, testX, testy, aux_trainX, aux_trainy, aux_testX, aux_testy, cfg, r) # change if you want to run another model
            score = score * 100.0
